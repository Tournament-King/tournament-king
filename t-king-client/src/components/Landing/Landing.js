    ...
    return (
        <main className="landing-wrapper">
            <div className="landing-splash">
                ...
                <div className="l-splash-right">
                    <p>Watch live tournaments for free.</p>
                    <p>Sign up for free to create tournaments of your own.</p>
                    <div className="bullets">
                    <p> -Select the competition type</p>
                    <p> -Enter players' names and a short description of the tournament</p>
                    <p> -Start matches, set scores and declare match winners, all broadcast live</p>
                    </div>
                </div>
            </div>
